...
async function getAllSpreadsheetValues(spreadsheetId, sheetName) { // isn't this a copy of shared_classes/ledger or shared_classes/googleSHeetsService???
	try {
		const auth = await getAuthToken(),
